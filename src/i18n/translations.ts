...
const ja: Translation = {
  ...
  portfolio: {
    ...
    lead: 'コンセプトだけのモックアップは見せません。これらはすべて、実際の現場の課題を解決し、現在も使われているプロダクトです。タップすると詳細をご覧いただけます。',
    seeCase: '詳しく見る',
    closeCase: '閉じる',
    retoLabel: '課題',
    solucionLabel: '解決策',
    ...
    projects: [
      ...
      {
        tag: 'Web × 3D',
        title: '今ご覧になっている、このカード',
        description:
          'スマートフォンをかざすとこのランディングページが開く、私自身のNFC名刺。ブラウザ上での3D表現、滑らかなスクロール、そして圧倒的な軽快さ。言葉で説明する必要はありません。あなたが今体験しているクオリティそのものが、私の技術の証明です。',
        stack: ['React', 'Three.js', 'GSAP', 'Lenis'],
  ...
  process: {
    kicker: '進め方',
    title: 'アイデアから納品まで',
    lead: '不透明なプロセスは一切ありません。最初のメッセージからリリース後のサポートまで、あなたと並走しながら形にしていくステップをご紹介します。',
    stepLabel: 'ステップ',
    steps: [
      {
        title: 'お問い合わせ',
      ...
      {
        title: '開発・調整',
        text: '静止画のモックアップではなく、ご自身のスマートフォンで実際に触って動かせる開発途中の画面を共有します。確認しながらリアルタイムに調整を重ねていきます。',
      },
      {
        title: '納品・公開',
  ...
  contact: {
    ...
    formNote:
      '※メッセージを入力した状態でWhatsAppが起動します。スパムや不要な登録は一切ありません。',
  },
